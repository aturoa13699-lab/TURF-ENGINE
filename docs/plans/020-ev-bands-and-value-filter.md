...
- Parser/readers (including `parse_stake_card`) must honor the derive flag and default to read-only without deriving extras; regression tests cover the default code path.
